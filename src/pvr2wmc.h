...
private:
  ...
  bool
      _discardSignalStatus; // flag to discard signal status for channels where the backend had an error
  ...
  long long
      _initialStreamPosition; // used to set an initial position (multiple clients watching the same live tv buffer)
